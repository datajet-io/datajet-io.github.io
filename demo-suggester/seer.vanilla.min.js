...
ready(function(){new autoComplete({selector:'input[name="q"]',minChars:2,cache:0,renderItem:function(a){var d="",c=a.br?a.br+" ":"";0==a.ty?(c=a.ca?' <span class="dj-sep">em</span> '+a.ca:"",c=a.br?a.br+' <span class="dj-sep">em</span> '+a.ti:a.ti+c):780<(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth)?(d=" product",c=(a.th?'<img class="dj-item-img" src="'+suggesterImgUrl+"/m_"+a.th+'">':"")+'<span class="dj-item-product"><strong class="dj-item-brand">'+c+'</strong><span class="dj-item-title">'+
