...
ready(function(){new autoComplete({selector:'input[name="q"]',minChars:2,cache:0,renderItem:function(a){var d="",c=a.br?a.br+" ":"";0==a.ty?c=a.br?a.br+' <span class="dj-sep">in</span> '+(a.ca?a.ca:a.ti):a.ti+(a.ca?' <span class="dj-sep">in</span> '+a.ca:""):780<(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth)?(d=" product",c=(a.th?'<img class="dj-item-img" src="'+suggesterImgUrl+"/m_"+a.th+'">':"")+'<span class="dj-item-product"><strong class="dj-item-brand">'+
...
c.length&&(a[e].ct="Search suggestions");5>c.length&&c.push(a[e]);break;case 1:0==f.length&&(a[e].ct="Related products"),4>f.length&&f.push(a[e])}d(c.concat(f))})}})});
