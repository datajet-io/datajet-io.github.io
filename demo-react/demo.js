...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Demo = __webpack_require__(159);

	var _Demo2 = _interopRequireDefault(_Demo);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_Demo2.default, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Suggester = __webpack_require__(162);

	var _Suggester2 = _interopRequireDefault(_Suggester);

	var _reactResponsiveCarousel = __webpack_require__(189);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('img', { src: item.images[0], title: item.title })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        customer.currency + item.price.current
	                    ),
	                    item.price.previous && _react2.default.createElement(
	                        'div',
	                        { className: 'product-price-old' },
	                        _react2.default.createElement(
	                            'span',
	                            null,
	                            customer.currency + item.price.previous
	                        ),
	                        ' ',
	                        '(' + Math.round(100 - item.price.current * 100 / item.price.previous) + '%)'
	                    )
	                ),
	                _react2.default.createElement(
	                    'a',
	                    { href: '#', onClick: this.props.openModal },
	                    'more like this'
	                )
	            );
	        }
	...
	var Demo = function (_React$Component2) {
	    ...
	    _createClass(Demo, [{
	        ...
	        value: function checkAuth(id) {
	            if (customer[id]) {
	                this.fetchData(customer[id], 'popularcategories', 'Popular Categories', 6, 1);
	                this.fetchData(customer[id], 'trendingproducts', 'Trending Products', 20, 5);

	                var uuid = _reactCookie2.default.load('DJUCID');

	                if (uuid) {
	                    this.fetchData(customer[id], 'recentlyviewed', 'Recently Viewed', 20, 2, uuid);
	                    this.fetchData(customer[id], 'popularincategory', 'Popular in Category', 20, 3, uuid);
	                    this.fetchData(customer[id], 'youmightlike', 'You might like', 20, 4, uuid);
	                }

	                this.setState({ customerId: id, customer: customer[id] });
	            }
	        }
	    }, {
	        key: 'openProductModal',
	        value: function openProductModal(item, event) {
	            event.preventDefault();
	            this.fetchData(this.state.customer, 'morelikethis', 'More Like This', 6, 6, null, item.id);
	            this.setState({ showProductModal: true, modalItem: item });
	        }
	    }, {
	        key: 'openCategoryModal',
	        value: function openCategoryModal(item, event) {
	            event.preventDefault();
	            this.fetchData(this.state.customer, 'bestsellers', 'Best Sellers', 6, 7, null, null, item.title);
	            this.setState({ showCategoryModal: true, modalCategory: item });
	        }
	    }, {
	        key: 'closeModal',
	        ...
	        key: 'buildUrl',
	        value: function buildUrl(uri, queryArgs) {
	            var url = uri + '?';
	            for (var name in queryArgs) {
	                if (queryArgs[name] != null) url += name + '=' + encodeURIComponent(queryArgs[name]) + '&';
	            }
	            url = url.slice(0, -1);
	            return url;
	        }
	        ...
	        key: 'fetchData',
	        value: function fetchData(customer, endpoint, title, size, order, uuid, sku, category) {
	            var _this3 = this;

	            var settings = {
	                key: customer.feedKey,
	                uuid: uuid,
	                size: size,
	                from: customer.dateRange
	            };

	            if (sku) settings.sku = sku;
	            if (title) settings.category = category;

	            var url = this.buildUrl('http://feed.' + customer.region + '.datajet.io/1.1/' + endpoint, settings);
	            var obj = this.state.feeds;

	            obj[order + '_' + endpoint] = [];
	            obj[order + '_' + endpoint].title = null;
	            ...
	            fetch(url, {
	                ...
	                obj[order + '_' + endpoint] = body.items;
	                obj[order + '_' + endpoint].title = title;
	                _this3.setState({ feeds: obj });
	        ...
	        value: function render() {
	            ...
	            if (this.state.feeds) {
	                ...
	                for (var k in this.state.feeds) {
	                    if (this.state.feeds.hasOwnProperty(k)) {
	                        sortedFeeds.push(k);
	                    }
	                }
	                sortedFeeds.sort();
	            ...
	            return _react2.default.createElement(
	                ...
	                this.state.customerId && _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'div',
	                                null,
	                                _react2.default.createElement(_Suggester2.default, null)
	                            )
	                        )
	                    ),
	                    sortedFeeds && sortedFeeds.map(function (key) {
	                        if (key == '1_popularcategories') {
	                            return _react2.default.createElement(
	                                'div',
	                                { key: key },
	                                _react2.default.createElement(
	                                ...
	                                _react2.default.createElement(
	                                    'div',
	                                    { className: 'row' },
	                                    _this4.state.feeds[key].map(function (item, i) {
	                                        return _react2.default.createElement(
	                                            'div',
	                                            { className: 'col-md-4', key: i },
	                                            _react2.default.createElement(
	                                                'a',
	                                                { href: '#', className: 'product-link',
	                                                    onClick: _this4.openCategoryModal.bind(_this4, item) },
	                                                _react2.default.createElement(
	                                                    'div',
	                                                    { className: 'category',
	                            ...
	                            if (key != '6_morelikethis') {
	                                var elements = _this4.state.feeds[key] || [];
	                                var components = elements.map(function (item, i) {
	                                    return _react2.default.createElement(Product, { key: i, item: item, customer: _this4.state.customer,
	                                        openModal: _this4.openProductModal.bind(_this4, item) });
	                                });
	                    ...
	                    this.state.showProductModal && _react2.default.createElement(
	                        'div',
	                        { className: 'demo-modal-container', onClick: this.closeModal.bind(this) },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'demo-modal-content modal-body' },
	                            _react2.default.createElement('img', { className: 'modal-image', src: this.state.modalItem.images[0],
	                                title: this.state.modalItem.title }),
	                            _react2.default.createElement(
	                                'div',
	                                ...
	                                _react2.default.createElement(
	                                    ...
	                                    this.state.modalItem.brand.name
	                                ),
	                            ...
	                            this.state.feeds['6_morelikethis'] && this.state.feeds['6_morelikethis'].map(function (item, i) {
	                                return _react2.default.createElement(Product, { key: i, item: item, customer: _this4.state.customer,
	                                    openModal: _this4.openProductModal.bind(_this4, item) });
	                            })
	                        )
	                    ),
	                    this.state.showCategoryModal && _react2.default.createElement(
	                        'div',
	                        { className: 'demo-modal-container', onClick: this.closeModal.bind(this) },
	                        _react2.default.createElement(
	                            'div',
	                            ...
	                            _react2.default.createElement(
	                                ...
	                                null,
	                                'Best Sellers in "',
	                                this.state.modalCategory.title,
	                                '"'
	                            ),
	                            this.state.feeds['7_bestsellers'] && this.state.feeds['7_bestsellers'].map(function (item, i) {
	                                return _react2.default.createElement(Product, { key: i, item: item, customer: _this4.state.customer,
	                                    openModal: _this4.openProductModal.bind(_this4, item) });
	                            })
	                        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutosuggest = __webpack_require__(163);
	...
	var Suggester = function (_React$Component) {
	    ...
	    function Suggester() {
	        ...
	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Suggester).call(this));
	    ...
	    _createClass(Suggester, [{
	        ...
	        value: function getSuggestions(value) {
	            ...
	            fetch('http://seer.usw.datajet.io/1.1/suggest/' + value + '?key=pYJDcBMdGR4tUM1OADt42LGvFSj7U5U&size=50', {
	                method: 'GET'
	            }).then(function (data) {
	                if (!data.ok) throw Error(data.statusText);
	                return data.json();
	                ...
	                for (var i = 0; i < items.length; i++) {
	                    switch (items[i].ty) {
	                        case 0:
	                            // Category
	                            if (categories.length == 0) items[i].ct = 'Sugestões de Busca';
	                            if (categories.length < 5) categories.push(items[i]);
	                            break;
	                        case 1:
	                            // Product
	                            if (products.length == 0) items[i].ct = 'Produtos Relacionados';
	                            if (products.length < 4) products.push(items[i]);
	                            break;
	                    }
	                }

	                var body = categories.concat(products);
	        ...
	        value: function onSuggestionSelected(event, _ref3) {
	            ...
	            document.location.href = '//' + suggestion.li;
	        }
	    }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerAndActions = __webpack_require__(183);

	var _reducerAndActions2 = _interopRequireDefault(_reducerAndActions);

	var _Autosuggest = __webpack_require__(184);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAutowhatever = __webpack_require__(185);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sectionIterator = __webpack_require__(186);

	var _sectionIterator2 = _interopRequireDefault(_sectionIterator);

	var _reactThemeable = __webpack_require__(187);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
		Carousel: __webpack_require__(190),
	    Thumbs: __webpack_require__(198)
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var klass = __webpack_require__(191);
	var merge = __webpack_require__(193);
	var CSSTranslate = __webpack_require__(194);
	var Swipe = __webpack_require__(196);
	var Thumbs = __webpack_require__(198);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var has3d = __webpack_require__(195);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(197)], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var klass = __webpack_require__(191);
	var has3d = __webpack_require__(195)();
	var outerWidth = __webpack_require__(199).outerWidth;
	var CSSTranslate = __webpack_require__(194);
	var Swipe = __webpack_require__(196);
