...
Datajet.Seer.prototype.get=function(a,d){if(""==a)d([]);else{var c=this.storage,f=this.ttl,g=this.storage.get(a);null!=g?d(g):this._ajax(this.seerUrl.replace("%QUERY",a),function(e){null===e&&(e=[]);c.set(a,e,f);d(e)})}};var css=".dj-autocomplete-suggestions{position:absolute;font-family:Arial,Helvetica,sans-serif;overflow:hidden;font-size:12px;background-color:#fff}.dj-autocomplete-suggestion{padding:6px 10px 4px;display:block;color:#000;text-decoration:none}@media (max-width:780px){.dj-autocomplete-suggestion{padding:7px 10px 7px 20px!important}.dj-autocomplete-suggestions{width:100%!important;left:0!important;font-size:16px!important;line-height:21px!important}}.dj-autocomplete-suggestion.selected,.dj-autocomplete-suggestion:hover{background-color:#f5f5f5}.dj-autocomplete-suggestion.product{line-height: 14px;width:25%;float:left;text-align:center;padding:0 4px;box-sizing:border-box;height:170px}.dj-autocomplete-category{display:block;background:#ececec;padding:6px 10px 4px;text-transform:uppercase;font-weight:700}.dj-item-img{max-width:80px;margin:5px 0}.dj-item-brand,.dj-item-price{display:block}.dj-item-title{display:block;height:30px;overflow:hidden}.dj-sep{color:gray}",
...
ready(function(){new autoComplete({selector:'input[name="q"]',minChars:2,cache:0,renderItem:function(a){var d="",c=a.br?a.br+" ":"";0==a.ty?c=a.br?a.br+' <span class="dj-sep">em</span> '+(a.ca?a.ca:a.ti):a.ti+(a.ca?' <span class="dj-sep">em</span> '+a.ca:""):780<(window.innerWidth||document.documentElement.clientWidth||document.body.clientWidth)?(d=" product",c=(a.th?'<img class="dj-item-img" src="'+suggesterImgUrl+"/m_"+a.th+'">':"")+'<span class="dj-item-product"><strong class="dj-item-brand">'+
c+'</strong><span class="dj-item-title">'+a.ti+'</span><strong class="dj-item-price">R$ '+a.cp+"</strong></span>"):c=a.ti;c='<a class="dj-autocomplete-suggestion'+d+'" data-link="'+a.li+'" href="//'+a.li+'">'+c+"</a>";a.ct&&(c='<div class="dj-autocomplete-category">'+a.ct+"</div>"+c);return c},onSelect:function(a,d,c){window.location.href=window.location.protocol+"//"+c.getAttribute("data-link")},source:function(a,d){var c=[],f=[];suggester.get(a,function(a){for(var e=0;e<a.length;e++)switch(a[e].ty){case 0:0==
c.length&&(a[e].ct="Sugest\u00f5es de busca");5>c.length&&c.push(a[e]);break;case 1:0==f.length&&(a[e].ct="Produtos relacionados"),4>f.length&&f.push(a[e])}d(c.concat(f))})}})});