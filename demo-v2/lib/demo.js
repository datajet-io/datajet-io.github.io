dataJetDemo = {
    ...
    settings: {
        recentlyViewedUrl: 'http://feed-v2.REGION.datajet.io/1.1/recentlyviewed',
        moreLikeThisUrl: 'http://feed-v2.REGION.datajet.io/1.1/morelikethis',
        bestSellersUrl: 'http://feed-v2.REGION.datajet.io/1.1/bestsellers',
        trendingProductsUrl: 'http://feed-v2.REGION.datajet.io/1.1/trendingproducts',
        popularCategoriesUrl: 'http://feed-v2.REGION.datajet.io/1.1/popularcategories',
        popularInCategoryUrl: 'http://feed-v2.REGION.datajet.io/1.1/popularincategory',
        youMightLikeThisUrl: 'http://feed-v2.REGION.datajet.io/1.1/youmightlike',
